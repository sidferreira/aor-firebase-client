      ...
      resourcesStatus[resource].then(function () {
        switch (type) {
          ...
          case _adminOnRest.DELETE:
            _firebase2.default.database().ref(resource + '/' + params.id).remove().then(function () {
          ...
          case _adminOnRest.UPDATE:
            ...
            _firebase2.default.database().ref(resource + '/' + params.id).update(dataUpdate).then(function () {
          ...
          case _adminOnRest.CREATE:
            ...
            if (!newItemKey) {
              var _newItemKey = _firebase2.default.database().ref().child(resource).push().key;
            ...
            _firebase2.default.database().ref(resource + '/' + newItemKey).update(dataCreate).then(function () {
